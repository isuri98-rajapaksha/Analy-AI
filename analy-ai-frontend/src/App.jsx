...
const newChat = () => {
  ...
  return (
    <div className="h-screen flex bg-gradient-to-br from-[#1A102B] via-[#24143A] to-[#2D1B47] text-white overflow-hidden">
      ...
      {/* SIDEBAR */}
      <div className="w-[270px] bg-gradient-to-b from-[#24143A] to-[#2D1B47] border-r border-[#7B61FF]/20 flex flex-col">
        {/* TOP */}
...
<div className="flex-1 overflow-y-auto px-10 py-4">
  ...
  src="/logo.png"
  alt="Analy AI"
  className="w-[320px] max-w-full object-contain mb-[-10px]"
/>

     <h1 className="text-4xl font-bold mt-0 whitespace-nowrap">
  ...
  <span className="ml-3 bg-gradient-to-r from-[#7B61FF] via-[#C084FC] to-[#F5D5E0] bg-clip-text text-transparent">
    Analy AI
      ...
      <p className="text-[#C9B4D4] mt-4 max-w-2xl">
    ...
    {messages.map((msg, index) => (
      ...
      >
        ...
        <div className={`max-w-[85%] prose prose-invert px-5 py-4 rounded-2xl text-sm leading-7 shadow-lg 
          ${msg.type === "user" 
    ...
    {loading && (
      <div className="flex justify-start">
        ...
        {/* INPUT AREA */}
        <div className="p-6 border-t border-[#7B337E]/20 bg-[#24143A]/60">
          ...
          <div className="max-w-4xl mx-auto bg-[#2D1B47]/20 border border-[#7B61FF]/20 rounded-3xl backdrop-blur-xl p-4 shadow-2xl">
            ...
            <textarea
              ...
              className="w-full h-18 bg-transparent resize-none outline-none text-[#F5D5E0] placeholder:text-[#C9B4D4] text-[15px]"
            />
  ...
  <p className="text-xs text-[#C9B4D4] mt-2">
    📄 {uploadedDocument.name}
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              {/* PDF BUTTON */}
              <label className="cursor-pointer bg-[#3B1657] hover:bg-[#4a1f6d] transition px-4 py-2 rounded-xl text-sm text-[#F5D5E0]">
                📎 Upload PDF
               <input
  type="file"
  className="hidden"
